...
int main(int argc, char **argv)
{
    ...
    airo_message::ReferenceStamped target_pose_7;
    ...
    while(ros::ok()){
        ...
        // Hovering pt
        target_pose_1.ref.pose.position.x = current_object_pose.pose.position.x-0.027; //shuttlerock: -0.025; ball: -0.017; dyed water: -0.0175
        target_pose_1.ref.pose.position.y = current_object_pose.pose.position.y+0.03; //shuttlerock: +0.03; ball: +0.012; dyed water: -0.02
        ...
        // Approaching pt
        target_pose_2.ref.pose.position.x = current_object_pose.pose.position.x-0.027; //shuttlerock: -0.025; ball: -0.017; dyed water: -0.0175
        target_pose_2.ref.pose.position.y = current_object_pose.pose.position.y+0.03; //shuttlerock: +0.03; ball: +0.012; dyed water: +0.02
        target_pose_2.ref.pose.position.z = 0.6; //shuttlerock: 0.6; ball: 0.6; dyed water: 0.45
        ...
        // Grasping pt
        target_pose_3.ref.pose.position.x = current_object_pose.pose.position.x-0.027; //shuttlerock: -0.025; ball: -0.017; dyed water: -0.0175
        target_pose_3.ref.pose.position.y = current_object_pose.pose.position.y+0.03; //shuttlerock: +0.03; ball: -0.012; dyed water: +0.02
        target_pose_3.ref.pose.position.z = 0.31; //shuttlerock: 0.31; ball: 0.28; dyed water: 0.295
        ...
        // Lifting pt 1
        target_pose_4.ref.pose.position.x = current_object_pose.pose.position.x-0.028;
        target_pose_4.ref.pose.position.y = current_object_pose.pose.position.y+0.03;
        target_pose_4.ref.pose.position.z = 0.6;
        ...
        // Lifting pt 2 
        target_pose_5.ref.pose.position.x = -2;
        target_pose_5.ref.pose.position.y = 0;
        target_pose_5.ref.pose.position.z = 1;
        ...
        // releasing pt
        target_pose_6.ref.pose.position.x = -1.653;
        ...
        // Pre-landing pt
        target_pose_7.ref.pose.position.x = 0;
        target_pose_7.ref.pose.position.y = -1.03;
        target_pose_7.ref.pose.position.z = 0.6;
        target_pose_7.ref.pose.orientation.w = 1.0;
        target_pose_7.ref.pose.orientation.x = 0.0;
        target_pose_7.ref.pose.orientation.y = 0.0;
        target_pose_7.ref.pose.orientation.z = 0.0;
        ...
        switch(state){
            ...
            case COMMAND:{
                if(fsm_info.is_waiting_for_command){
                    ...
                    if (target_5_reached){
                        ...
                        if(abs(local_pose.pose.position.x - target_pose_5.ref.pose.position.x)
                         ...
                         + abs(local_pose.pose.position.z - target_pose_5.ref.pose.position.z) < 0.3){
                            ...
                            // if (cnt<100){
                            //     cnt++;
                            //     std::cout<<"reaching lifting point"<<std::endl;
                            // }
                            // else{
                            //     cnt = 0;
                    ...
                    if(target_7_reached){
                        target_pose_7.header.stamp = ros::Time::now();
                        command_pub.publish(target_pose_7);
                        
                        if(abs(local_pose.pose.position.x - target_pose_7.ref.pose.position.x)
                         + abs(local_pose.pose.position.y - target_pose_7.ref.pose.position.y)
                         + abs(local_pose.pose.position.z - target_pose_7.ref.pose.position.z) < 0.3){
                            std::cout<<"--- ---- current tracking error -------"<<std::endl;
                            std::cout<<"x tracking error: "<< local_pose.pose.position.x - target_pose_7.ref.pose.position.x << std::endl;
                            std::cout<<"y tracking error: "<< local_pose.pose.position.y - target_pose_7.ref.pose.position.y << std::endl;
                            std::cout<<"z tracking error: "<< local_pose.pose.position.z - target_pose_7.ref.pose.position.z << std::endl;                           
                            //state = LAND;
