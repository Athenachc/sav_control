...
void datalogger(int i){
    if (i == 1){
    std::ofstream save("/root/airo_control_interface_ws/src/airo_control_interface/airo_control/src/tracking_errors/grasp.csv", std::ios::app);
    ...
    if (i == 2){
    std::ofstream save("/root/airo_control_interface_ws/src/airo_control_interface/airo_control/src/tracking_errors/lift.csv", std::ios::app);
    save<<std::setprecision(20)<<ros::Time::now().toSec()<<
    ...
    if (i == 3){
    std::ofstream save("/root/airo_control_interface_ws/src/airo_control_interface/airo_control/src/tracking_errors/release.csv", std::ios::app);
    save<<std::setprecision(20)<<ros::Time::now().toSec()<<
    ...
    if (i == 4){
    std::ofstream save("/root/airo_control_interface_ws/src/airo_control_interface/airo_control/src/tracking_errors/land.csv", std::ios::app);
    save<<std::setprecision(20)<<ros::Time::now().toSec()<<
        ","<<local_pose.pose.position.x <<","<< target_pose_3.ref_pose.position.x
        <<","<<local_pose.pose.position.y <<","<< target_pose_3.ref_pose.position.y
